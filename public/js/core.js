...
const TOOLS = [
  ...
  {id:'perf-lab',      label:'REST Load Tester',           desc:'Load-test endpoints with a live thread slider and latency tracking',                 color:'#e84393',         icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>',        section:'Performance & Testing'},
...
async function navigate(toolId, navEl, initialTab) {
  ...
  document.getElementById('topbar-subtitle').textContent = (toolId === 'home') ? 'MxDev Swiss Tool v1.40.0' : (tool.desc || '');
