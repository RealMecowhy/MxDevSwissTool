...
// ============================================================
let encMode='base64';
function encSetMode(m,tab) { encMode=m; document.querySelectorAll('#panel-encoder .tab').forEach(t=>{t.classList.remove('active');t.setAttribute('aria-selected','false');}); if(tab) {tab.classList.add('active'); tab.setAttribute('aria-selected','true');} document.getElementById('enc-input').value=''; document.getElementById('enc-output').value=''; }
