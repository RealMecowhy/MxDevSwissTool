...
const TOOLS_HELP = {
  ...
  'architecture': {
    ...
    description: 'Tool for rapid visualization of architecture and database relationships using text code and Mermaid diagrams. Allows you to instantly draw a Domain Model without using heavy graphic tools. The diagram renderer (3.5&nbsp;MB) is fetched the first time you draw something rather than at startup, so the very first diagram may take a moment; every one after it is instant. If it cannot be fetched, the diagram source is shown instead — you can paste it into the Mermaid Live Editor.',
    howToGet: `
